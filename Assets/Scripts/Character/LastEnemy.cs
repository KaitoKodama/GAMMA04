...
using DG.Tweening;
using CommonUtility;
using State = StateMachine<LastEnemy>.State;

public class LastEnemy : EnemyBase
{
    [SerializeField] SOEnemyData enemyData;
    [SerializeField] GameObject attackEffect;
    private Actor actor;
    private StateMachine<LastEnemy> stateMachine;

	private void Start()
	{
        Init(enemyData);

        stateMachine = new StateMachine<LastEnemy>(this);
